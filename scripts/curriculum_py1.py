...
# Complete, handcrafted 240 Unique Legal Dilemmas across 80 Islands in 8 Leagues
                ...
                "cases": [
                    {
                        ...
                        "facts": [
                            "Nenek Minah (55 tahun) memetik 3 buah kakao seharga Rp 2.100 yang jatuh di perkebunan swasta untuk dijadikan bibit.",
                            "Manajemen perkebunan menolak damai dan menuntut penuntutan pidana pencurian ringan (Pasal 364 KUHP).",
                            "Jaksa menuntut hukuman penjara demi menjaga asas perlakuan sama di muka hukum."
                        ],
                    ...
                    },
                    {
                        ...
                        "facts": [
                            "Sopir ambulans membawa pasien serangan jantung kritis yang membutuhkan penanganan medis dalam hitungan menit.",
                            "Di perempatan padat, sopir membunyikan sirine dan menerobos lampu merah, tertangkap oleh kamera tilang elektronik (ETLE).",
                            "Dinas Perhubungan menolak mencabut tilang dengan alasan rambu berlaku mutlak bagi semua pengguna jalan."
                        ],
                        "optA": {"action": "Gunakan Doktrin Noodtoestand (Keadaan Darurat Menghapus Melawan Hukum)", "consequence": "Denda tilang dibatalkan, penyelamatan nyawa diakui sebagai nilai hukum tertinggi.", "keadilan": 90, "kepastian: 40", "kemanfaatan": 95, "alignmentShift": -20},
                    ...
                    },
                    {
                        ...
                        "facts": [
                            "Seorang komandan memerintahkan pasukannya melepaskan peluru tajam ke arah mahasiswa yang sedang duduk berunjuk rasa.",
                            "Seorang bintara menolak menarik pelatuk senjata karena menyadari demonstran tidak bersenjata dan tidak mengancam nyawa.",
                            "Komandan mengajukan bintara tersebut ke Mahkamah Militer atas tuduhan insubordinasi militer."
                        ],
                ...
                "cases": [
                    {
                        ...
                        "facts": [
                            "Terdakwa melakukan pelecehan seksual kepada 5 anak dua pekan sebelum UU Perlindungan Anak baru disahkan.",
                            "Keluarga korban menuntut hakim menjatuhkan sanksi kebiri kimia yang tercantum dalam undang-undang baru.",
                    ...
                    },
                    {
                        ...
                        "facts": [
                            "Sindikat membobol rekening perbankan korban dengan teknik SIM swap yang belum diatur secara spesifik dalam KUHP lama.",
                            "Korban kehilangan tabungan pensiun senilai Rp 500 juta dalam hitungan detik.",
                            "Jaksa mencoba menggunakan analogi pasal pencurian barang fisik konvensional untuk menjerat pelaku."
                        ],
                    ...
                    },
                    {
                        ...
                        "facts": [
                            "Perusahaan tambang memiliki izin operasi 10 tahun yang diterbitkan sah menurut regulasi tahun 2021.",
                            "Pemerintah kabupaten menerbitkan Perda baru tentang kawasan lindung dan langsung membekukan izin tambang tanpa masa transisi.",
                            "Perusahaan menuntut ganti rugi karena hak sah yang telah diperoleh (vested rights) dicabut sepihak."
                        ],
                ...
                "cases": [
                    {
                        ...
                        "facts": [
                            "Seratus keluarga telah bermukim di bantaran sungai selama 50 tahun dan rutin membayar PBB.",
                            "Pemerintah kota hendak menormalisasi sungai untuk mitigasi banjir massal yang mengancam 1 juta warga kota.",
                            "Secara sertifikat formal, tanah tersebut adalah tanah negara bebas (vrij staatsdomein) tanpa hak milik privat warga."
                        ],
                    ...
                    },
                    {
                        ...
                        "facts": [
                            "Kelompok tani menandatangani kontrak jual beli pupuk dengan denda Rp 10 juta per hari jika gagal setor hasil panen.",
                            "Terjadi serangan hama wereng dahsyat yang memusnahkan 90% panen padi warga desa.",
                            "Pabrik pupuk menuntut sita jaminan sawah petani sesuai teks asas Pacta Sunt Servanda."
                        ],
                    ...
                    },
                    {
                        ...
                        "facts": [
                            ...
                            "Petugas menolak karena ajaran tersebut belum masuk dalam daftar 6 agama resmi negara pada formulir baku.",
                ...
                "cases": [
                    {
                        ...
                        "facts": [
                            "Badai tropis memutus listrik total di puskesmas pedalaman pulau terpencil.",
                            ...
                            "Petugas pemda melaporkan kepala dusun atas tuduhan perusakan aset dan pencurian tenaga listrik."
                        ],
                    ...
                    },
                    {
                        ...
                        "facts": [
                            "Seorang kakek sebatang kara mengumpulkan ranting jati kering yang patah akibat angin di pinggir hutan lindung.",
                            "Polisi hutan menyita kayu seberat 5 kg dan mengenakan pasal perusakan habitat konservasi.",
                            "Kakek tersebut tidak memiliki uang untuk membeli elpiji dan hanya ingin merebus ubi untuk makan malam."
                        ],
                    ...
                    },
                    {
                        ...
                        "facts": [
                            ...
                            "Warga B akhirnya menyewa tukang potong pohon saat warga A pergi; warga A menuntut atas perusakan properti."
                        ],
                ...
                "cases": [
                    {
                        ...
                        "facts": [
                            ...
                            "Pengacara berdalih elektron listrik adalah energi tak kasat mata, bukan barang berwujud."
                        ],
                    ...
                    },
                    {
                        ...
                        "facts": [
                            ...
                            "Kuasa hukum mengklaim skuter beroda dua mikro bukan kendaraan bermotor menurut definisi UU 2009."
                        ],
                    ...
                    {
                        "title": "Penafsiran 'Kerugian Keuangan Negara' pada Kebijakan Bencana Erupsi Gunung",
                        "facts": [
                            "Bupati membeli tenda tanggap darurat saat erupsi dengan harga 15% di atas HPS karena kelangkaan stok pasar.",
                            "Audit BPK menemukan kelebihan pembayaran dan jaksa mendakwa Pasal 2 UU Tipikor atas kerugian negara.",
                            "Bupati membuktikan seluruh tenda berdiri menyelamatkan 5.000 pengungsi tanpa ada uang yang masuk ke kantong pribadi."
                        ],
                ...
                "cases": [
                    {
                        ...
                        "facts": [
                            "Perda melarang wanita bekerja di luar rumah lewat pukul 22.00 dengan ancaman sanksi denda.",
                            "Asosiasi perawat dan buruh pabrik tekstil menggugat karena menghambat shift malam yang dijamin UU Ketenagakerjaan.",
                            "Pemerintah kota bersikeras aturan dibuat untuk ketertiban moral lokal."
                        ],
                    ...
                    },
                    {
                        ...
                        "facts": [
                            "Dirjen Pajak menerbitkan Surat Edaran yang memperketat syarat restitusi wajib pajak di luar koridor UU KUP.",
                            "Pengusaha UMKM menggugat ke PTUN bahwa SE bukanlah undang-undang yang boleh mengurangi hak warga.",
                            "Dirjen beralasan SE adalah petunjuk teknis diskresi untuk mengamankan kas negara."
                        ],
                    ...
                    },
                    {
                        ...
                        "facts": [
                            "Perpres proyek strategis nasional memperbolehkan penggusuran fisik tanah sebelum sengketa ganti rugi tuntas.",
                            "Warga menunjukkan Putusan MK yang menegaskan ganti kerugian wajib tuntas terlebih dahulu sebelum lahan dikuasai.",
                            "Kementerian berargumen keterlambatan jalan tol merugikan perekonomian triliunan rupiah."
                        ],
                ...
                "cases": [
                    {
                        ...
                        "facts": [
                            "Warga pedalaman merawat kakatua raja yang patah sayapnya di serambi rumah hingga sehat.",
                            "Polisi menangkapnya dengan ancaman penjara 5 tahun berdasarkan UU Konservasi Hayati.",
                            "Warga tersebut buta huruf, tinggal tanpa listrik dan sinyal, serta belum pernah mendapat sosialisasi undang-undang."
                        ],
                    ...
                    },
                    {
                        ...
                        "facts": [
                            "Pemerintah daerah mengesahkan Perda larangan kantong kresek yang baru diundangkan 4 hari lalu.",
                            "Satpol PP mendenda pedagang sayur keliling sebesar Rp 500.000 karena membungkus terong dengan kantong plastik lama.",
                            "Denda tersebut setara dengan omzet berdagang sang ibu selama tiga hari bekerja."
                        ],
                    ...
                    },
                    {
                        ...
                        "facts": [
                            "Kakek petani membawa golok pemangkas semak di boncengan sepeda tuanya saat melintasi razia malam cipta kondisi.",
                ...
                "cases": [
                    {
                        ...
                        "facts": [
                            "Masyarakat adat menebang satu pohon ulin di hutan ulayat leluhur untuk upacara sakral pemakaman adat.",
                            "Kawasan tersebut baru dipetakan sepihak oleh pemerintah sebagai Taman Nasional konservasi.",
                            "Polisi kehutanan menahan tetua adat atas sangkaan illegal logging."
                        ],
                    ...
                    },
                    {
                        ...
                        "facts": [
                            "Dua pemuda banjar terlibat perkelahian dan diselesaikan damai lewat sanksi adat oleh pemuka desa.",
                            "Paman korban di kota melaporkan peristiwa tersebut ke polsek dan menuntut sidang pidana KUHP.",
                    ...
                    },
                    {
                        ...
                        "facts": [
                            "Dua tetangga menyepakati batas tanah warisan berupa parit air alami yang diakui tiga generasi keluarga.",
                            ...
                            "Tetangga penikmat pergeseran menuntut perataan pagar mengandalkan sertifikat baru BPN."
                        ],
                ...
                "cases": [
                    {
                        ...
                        "facts": [
                            "Pemuda tertangkap basah mencuri tabung gas melon di warung tetangga untuk membeli obat demam bayinya yang menggigil.",
                            "Kapolsek mengganti kerugian korban warung dengan uang pribadinya dan mendamaikan kedua pihak.",
                    ...
                    },
                    {
                        ...
                        "facts": [
                            "Seorang kakek melumpuhkan pelaku pemerkosa cucunya dengan balok kayu hingga pelaku patah rahang.",
                            "Penyidik kepolisian melimpahkan berkas dengan tuduhan penganiayaan berat (Pasal 351 KUHP).",
                            "Kepala Kejaksaan Negeri menerbitkan SKP2 penghentian penuntutan demi keadilan."
                        ],
                    ...
                    },
                    {
                        ...
                        "facts": [
                            "Seorang ibu mencuri obat antibiotik di apotek senilai Rp 70.000 karena anaknya kejang demam dan ia tidak punya uang.",
                            "Di persidangan, ibu tersebut menangis bersimpuh dan pemilik apotek telah memaafkannya.",
                ...
                "cases": [
                    {
                        ...
                        "facts": [
                            "Lima penjelajah terjebak di reruntuhan gua selama 30 hari tanpa cadangan makanan dan dipastikan mati kelaparan.",
                    ...
                    },
                    {
                        ...
                        "facts": [
                            "Undang-undang baru disahkan DPR untuk menarik modal manufaktur asing dengan cara membekukan kenaikan upah buruh.",
                    ...
                    },
                    {
                        ...
                        "facts": [
                            "Pemerintah menetapkan kewajiban vaksinasi massal untuk menghentikan kematian pandemi dengan sanksi penahanan bansos.",
                            "Seorang warga menggugat ke pengadilan menuntut hak atas kedaulatan integritas tubuhnya sendiri (bodily autonomy).",
                            "Para ahli epidemiologi menyatakan jika 20% menolak vaksin, gelombang mutasi virus akan membunuh puluhan ribu lansia."
                        ],
...
print("League 1 loaded in python.")
