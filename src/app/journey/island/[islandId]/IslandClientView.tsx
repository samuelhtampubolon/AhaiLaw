...
export default function IslandClientView({ initialIslandId }: { initialIslandId?: string }) {
  const params = useParams();
  const paramIsland = Array.isArray(params?.islandId) ? params.islandId[0] : params?.islandId;
  const islandId = paramIsland || initialIslandId || "1-1";
